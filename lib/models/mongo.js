        ...
        Model.prototype.fetch = function fetch(select_clause) {
            ...
            return new Promise(function(resolve, reject) {
                getClient(function(err, client) {
                    ...
                    //  deleting all properties which are undefined because otherwise mongo will make them query part which results
                    //  inappropriate data 
                    client.collection(self.tableName).find(
                    deleteAllPropertiesWhichAreUndefined(self.getMongoDataObject(self.input)), select_clause, {
                        limit: 1
