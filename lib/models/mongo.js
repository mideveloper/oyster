        ...
        function saveData(context, input) {
            ...
            return new Promise(function (resolve, reject) {
                getClient(server, pools, function (err, client) {
                    ...
                    client.collection(context.tableName).save(context.getDBObject(input), function (err, output) {
                        if (err) {
                            reject(err);
                            return;
                        }
        ...
        Model.prototype.removeArrayItems = function removeArrayItems(where_clause) {
            ...
            return new Promise(function(resolve, reject) {
                getClient(server, pools, function(err, client) {
                    ...
                    var db_object = self.getDBObject(where_clause);
                    client.collection(self.tableName).update(
                    db_object, {
                        $pull: db_object
                    }, function(err, output) {
