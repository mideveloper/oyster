...
var unAuthenticatedError = function (err) {
    this.httpCode = "401";
    this.error_message = err ? err : Constants.messages.AUTH_FAILED;
};
...
var notFoundError = function (err, arg) {
    this.httpCode = "500";
    this.error_message = err ? err : Util.format(Constants.messages.NOT_FOUND, arg);
};
...
var invalidArgumentsError = function (err) {
    this.httpCode = "400";
    this.error_message = err ? err : Constants.messages.INVALID_ARGS;
};
